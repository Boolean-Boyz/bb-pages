...
<style>
  ...
  .fopl-content p {
    font-size: 1.05rem; line-height: 1.85; color: #e8f5e9; margin: 0 0 20px;
  }

  /* ── Timeline ── */
  .fopl-timeline { margin: 40px 0; border-left: 3px solid rgba(255,255,255,0.4); padding-left: 28px; }
  ...
  .fopl-timeline-year {
    ...
    text-transform: uppercase; letter-spacing: 0.1em; color: #a5d6a7; margin-bottom: 4px;
  }
  .fopl-timeline-item p { margin: 0; font-size: 1rem; color: #e8f5e9; line-height: 1.7; }
...
<div class="fopl-content">
  ...
  <div style="display:flex;align-items:center;gap:12px;margin:32px 0 8px;" aria-hidden="true">
    <div style="flex:1;height:1px;background:rgba(255,255,255,0.25);"></div>
    <span style="color:rgba(255,255,255,0.6);font-size:1.1rem;letter-spacing:0.3em;">✦ ✦ ✦</span>
    <div style="flex:1;height:1px;background:rgba(255,255,255,0.25);"></div>
  </div>
